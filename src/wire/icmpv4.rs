...
fn set(buffer: &mut [u8], kind: Icmpv4PacketKind) {
...
impl Icmpv4PacketKind {
    ...
    pub fn buffer_len(&self) -> usize {
        match *self {
            ...
            | Icmpv4PacketKind::EchoReply { ref payload, .. } => payload.len() + 8,
            Icmpv4PacketKind::TtlExpiredTcp { .. } | Icmpv4PacketKind::TtlExpiredUdp { .. } => 36,
        }
    }
}
...
impl Icmpv4Packet {
    ...
    pub fn new_from_kind(kind: Icmpv4PacketKind) -> Icmpv4Packet {
    ...
    pub fn write_to_buffer(buffer: &mut [u8], kind: Icmpv4PacketKind) {
        set(buffer, kind);
    }
